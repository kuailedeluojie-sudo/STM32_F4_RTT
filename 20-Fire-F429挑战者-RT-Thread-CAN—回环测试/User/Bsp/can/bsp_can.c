...
static void CAN_Mode_Config(void)
{
  ...
  RCC_APB1PeriphClockCmd(CAN_CLK, ENABLE);
	...
	CAN_InitStructure.CAN_Prescaler =10;		   ////BTR-BRP 波特率分频器  定义了时间单元的时间长度 45/(1+5+3)/5=1 Mbps
...
static void CAN_Filter_Config(void)
{
	...
	//CAN_FilterInitStructure.CAN_FilterIdHigh= ((((u32)0x0314<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF0000)>>16;		//要筛选的ID高位 
	//CAN_FilterInitStructure.CAN_FilterIdLow= (((u32)0x0314<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF; //要筛选的ID低位 
...
//  TxMessage->IDE=CAN_ID_EXT;					 //扩展模式
 //CAN_ID_STD
  ...
  TxMessage->DLC=8;							 //数据长度为8字节
	...
	for (ubCounter = 0; ubCounter < 8; ubCounter++)
  {
    TxMessage->Data[ubCounter] = ubCounter * 3;
  }
}
/**************************END OF FILE************************************/
